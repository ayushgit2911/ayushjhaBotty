...
BAALAJI_TG_USER_BOT = "Hey, so sorry but i haven't approved you to PM."
TG_COMPANION_USER_BOT = "Please wait for my response (generally approved) So don't spam in my PM."
UNIBORG_USER_BOT_WARN_ZERO = "I am mainly offline now it's around the my exams time. Please do not SPAM here's and irrigate me."
UNIBORG_USER_BOT_NO_WARN = "[──▄█▀█▄─────────██ \n▄████████▄───▄▀█▄▄▄▄ \n██▀▼▼▼▼▼─▄▀──█▄▄ \n█████▄▲▲▲─▄▄▄▀───▀▄ \n██████▀▀▀▀─▀────────▀▀](t.me/ayushjha_2911) \n\n Thank you for contacting me but i Am mainly Offline Now bcz it's around the my exams time, i will message once I get free and comes to online....."
