...
async def _(event):
    ...
    await event.edit("..Let me kang this little sticker for u my lord...")
    ...
    await event.edit(f"Lol .. I kanged sticker for my Master [here](t.me/addstickers/{packshortname})")
