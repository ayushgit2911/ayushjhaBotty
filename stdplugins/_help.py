...
async def _(event):
    ...
    if splugin_name in borg._plugins:
        ...
        s_help_string = "****:"
    help_string = """@UniBorg ( **Custom Built By** @ayushjha_2911 ) \n**Verified Account**: ✅\n**Official Website**: https://ayushjha2911.wordpress.com\n
Pithun {}
Talethrun {}

**Custom Built Fork**: https://github.com/ayushjha2911""".format(
        sys.version,
        __version__
    )
...
@borg.on(admin_cmd(pattern="more (.*)"))
async def _(event):
    if event.fwd_from:
        return
